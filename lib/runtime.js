...
class ProtostarRuntime {
    constructor({lenient = true, cachingEnabled = false, protostarDirPath, port = 8888, projectConfigFilename = 'prototype.json', mode, projectDirPath, targetDirPath, themeDirPath, launchTime = new Date().getTime()}) {
        ...
        if(typeof protostarDirPath !== 'string')
            throw new Error("missing protostarDirPath");

        /**
         * @type {String}
         */
        this.protostarDirPath  = protostarDirPath;
         ...
         * @type {Number}
         */
        this.port = (process.env["VCAP_APP_PORT"] || port );

        /**
         * @type {String}
         */
        this.projectConfigFilename = projectConfigFilename;
