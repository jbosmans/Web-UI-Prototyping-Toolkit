...
var browserCommands = readBrowserCommandMeta();
    logger.debug("Available browser commands: ", browserCommands.map(function(c){
    return c.name;
}));
...
logger.debug("Qualified Command Names = ", qualifiedCommandNames);
var shortCommandNames = createShortCommandNamePathMap();
logger.debug("Short Command Names = ", shortCommandNames);
