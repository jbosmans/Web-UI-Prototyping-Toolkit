        ...
        return new Promise((resolve, reject) => {
            ...
            try {
                ...
                if (!namedPathUrlPathname) {
                    ...
                    const sassEquiv = projEquivPath.substring(0, projEquivPath.lastIndexOf('.')) + ".scss";
                ...
                if(atdu.indexOf('co:head') >= 0 || atdu.indexOf('dyn-cs') >= 0){
                    console.info("No need to copy anything for a content spot definition: " + atdu);
                    resolve();
                    return;
                }
    ...
    finalRun(compiledTemplates, callBack) {
        ...
        for (let tp in compiledTemplates) {
            ...
            if (this.cleanupCompiledHtml) {
                ...
                this._runtime.writeFile(targetFilePath, removedComments);
            } else {
