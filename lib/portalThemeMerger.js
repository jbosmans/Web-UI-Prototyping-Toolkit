...
function PortalThemeMerger(args) {
    ...
    this.relativize = function(paths, refDirPath){
        var out = [];
        var rdp = refDirPath;
    ...
    this.copyThePaths = function(copyPaths){
    ...
    this.mergeStatic = function(){
        ...
        return new Promise(function(resolve, reject){
            ...
            builder.buildPrototype().done(function(){
                ...
                that.copyThePaths(that.pathsToCopy);
    ...
    this.prepareComponentDir = function(cmpDir){
        ...
        var relativeFiles = {
            html: this.relativize(files.html, cmpDir),
            js: this.relativize(files.js, cmpDir),
            css: this.relativize(files.css, cmpDir)
        };
