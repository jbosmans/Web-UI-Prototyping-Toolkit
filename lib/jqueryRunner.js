...
try{
    jsdom = require('jsdom');
    logger.debug("jsdom node module is installed, will attempt to use fullblown jQuery serverside (make sure the jquery node module is installed as well)");
}catch(jsdomErr){
    logger.debug("jsdom node module is not installed, reverting to cheerio", jsdomErr);
